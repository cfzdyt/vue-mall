							...
							<li v-for="item in cartList">
								...
								<div class="cart-tab-5">
									<div class="cart-item-opration">
										<a 
											href="javascript:;" 
											class="item-edit-btn"   											@click="delCartConfirm(item.productId)"
											>
							...
							<div class="item-all-check">
								...
								@click="chekAll"
								 >
									<span 
									class="checkbox-btn item-check-btn" 
									:class="{'check':chekAllFlag}"
									>
                     				 <svg 
                     				 class="icon icon-ok"><use xlink:href="#icon-ok"/>
                     				 </svg>
                  					</span>
									<span>全选</span>
								</a>
